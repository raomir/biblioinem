...
public class Lista extends javax.swing.JPanel {
    ...
    void limpiaCampos() {
        if (tablaTemas.getSelectedRow() > -1) {
            tablaTemas.removeRowSelectionInterval(tablaTemas.getSelectedRow(), tablaTemas.getSelectedRow());
        }
        op.listarTema("");
    }
    /**
    ...
    private void initComponents() {
        ...
        tablaTemas.setCursor(new java.awt.Cursor(java.awt.Cursor.HAND_CURSOR));
        ...
        txtBuscar.setPlaceholder("Buscar tema...");
    ...
    private void txtBuscarKeyReleased(java.awt.event.KeyEvent evt) {//GEN-FIRST:event_txtBuscarKeyReleased
        ...
        op.listarTema(txtBuscar.getText());
    ...
    public void actualizar(){
        if (tablaTemas.getRowCount() > 0) {
            if (tablaTemas.getSelectedRowCount() > 0) {
                int fila = tablaTemas.getSelectedRow();
                s.setIdTema(tablaTemas.getValueAt(fila, 0).toString());
                s.setNombreTema(tablaTemas.getValueAt(fila, 1).toString());
    ...
    protected static javax.swing.JTable tablaTemas;
