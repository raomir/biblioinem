...
public class Actualizar extends JFrame{
    ...
    public Actualizar() {
        ...
        txtTema.setText(s.getNombreTema());
    }
    ...
    private void initComponents() {
        ...
        jLabel1.setText("Actualizar Tema");
        ...
        txtTema.setPlaceholder("Titulo...");
        txtTema.setSoloLetras(true);
        jPanel1.add(txtTema, new org.netbeans.lib.awtextra.AbsoluteConstraints(150, 120, 190, -1));
        ...
        jPanel1.add(jLabel2, new org.netbeans.lib.awtextra.AbsoluteConstraints(150, 100, 110, -1));
    ...
    private void btnRegistrarActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btnRegistrarActionPerformed
        s.setNombreTema(txtTema.getText());
        getCamposVacios();
    }//GEN-LAST:event_btnRegistrarActionPerformed
    
    private void getCamposVacios(){
        if (!txtTema.getText().isEmpty()){ 
            int rsu = op.actualizarTema();
            if (rsu == 1) {
                    Registro re = new Registro();
                    re.lblNombre.setText("tema");
                    re.setVisible(true);
                    op.listarTema("");
                    getLimpiarCampos();
            }else{
