...
public class Lista extends javax.swing.JPanel {
    ...
    void limpiaCampos() {
        if (tablaLibros.getSelectedRow() > -1) {
            tablaLibros.removeRowSelectionInterval(tablaLibros.getSelectedRow(), tablaLibros.getSelectedRow());
        }
        op.listarLibro("");
    }
    /**
    ...
    private void initComponents() {
        ...
        tablaLibros.setModel(new javax.swing.table.DefaultTableModel(
            ...
            new String [] {
                "IdLibro", "Titulo", "Autor", "Tema", "Editorial", "Idioma", "Categoría", "Edición", "Pasillo", "Cantidad"
            }
        ) {
        ...
        txtBuscar.setPlaceholder("Buscar libro...");
    ...
    private void txtBuscarKeyReleased(java.awt.event.KeyEvent evt) {//GEN-FIRST:event_txtBuscarKeyReleased
        ...
        op.listarLibro(txtBuscar.getText());
    ...
    public void actualizar(){
        if (tablaLibros.getRowCount() > 0) {
            if (tablaLibros.getSelectedRowCount() > 0) {
                ...
                s.setIdLibro(tablaLibros.getValueAt(fila, 0).toString());
                s.setTitulo(tablaLibros.getValueAt(fila, 1).toString());
                s.setAutor(tablaLibros.getValueAt(fila, 2).toString());
                s.setTema(tablaLibros.getValueAt(fila, 3).toString());
                s.setEditorial(tablaLibros.getValueAt(fila, 4).toString());
                s.setIdioma(tablaLibros.getValueAt(fila, 5).toString());
                s.setCategoría(tablaLibros.getValueAt(fila, 6).toString());
                s.setEdicion(tablaLibros.getValueAt(fila, 7).toString());
                s.setPasillo(tablaLibros.getValueAt(fila, 8).toString());
                s.setCantidad(Double.parseDouble(tablaLibros.getValueAt(fila, 9).toString()));
