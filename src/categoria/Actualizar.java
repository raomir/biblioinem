...
public class Actualizar extends JFrame{
    ...
    public Actualizar() {
        ...
        txtCategoria.setText(s.getNombreCategoria());
    }
    ...
    private void initComponents() {
        ...
        txtCategoria.setPlaceholder("Titulo...");
        txtCategoria.setSoloLetras(true);
        jPanel1.add(txtCategoria, new org.netbeans.lib.awtextra.AbsoluteConstraints(150, 120, 190, -1));
    ...
    private void btnRegistrarActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btnRegistrarActionPerformed
        s.setNombreCategoria(txtCategoria.getText());
        getCamposVacios();
    }//GEN-LAST:event_btnRegistrarActionPerformed
    
    private void getCamposVacios(){
        if (!txtCategoria.getText().isEmpty()){ 
            int rsu = op.actualizarCategoria();
            if (rsu == 1) {
