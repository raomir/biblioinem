...
public class Nuevo extends javax.swing.JFrame {
    ...
    private void initComponents() {
        ...
        txtCategorias = new rojeru_san.RSMTextFull();
        ...
        jLabel1.setText("Registrar Categorías");
        ...
        txtCategorias.setHorizontalAlignment(javax.swing.JTextField.CENTER);
        txtCategorias.setBordeColorFocus(new java.awt.Color(204, 204, 204));
        txtCategorias.setMayusculas(true);
        txtCategorias.setPlaceholder("Nombre categorías...");
        txtCategorias.setSoloLetras(true);
        jPanel1.add(txtCategorias, new org.netbeans.lib.awtextra.AbsoluteConstraints(140, 130, 190, -1));
    ...
    private void btnRegistrarActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btnRegistrarActionPerformed
        s.setNombreCategoria(txtCategorias.getText());
        getCamposVacios();
    }//GEN-LAST:event_btnRegistrarActionPerformed
    
    private void getCamposVacios(){
        if (!txtCategorias.getText().isEmpty()){ 
            int rsu = op.ingresarCategoria();
            if (rsu == 1) {
                    Registro re = new Registro();
                    re.lblNombre.setText("categoría");
                    re.setVisible(true);
                    op.listarCategoria("");
                    getLimpiarCampos();
            }else{
    ...
    protected static rojeru_san.RSMTextFull txtCategorias;
