...
public class Lista extends javax.swing.JPanel {
    ...
    void limpiaCampos() {
        if (tablaAutores.getSelectedRow() > -1) {
            tablaAutores.removeRowSelectionInterval(tablaAutores.getSelectedRow(), tablaAutores.getSelectedRow());
        }
        op.listarAutor("");
    }
    /**
    ...
    private void initComponents() {
        ...
        tablaAutores.setCursor(new java.awt.Cursor(java.awt.Cursor.HAND_CURSOR));
        ...
        txtBuscar.setPlaceholder("Buscar autor...");
    ...
    private void txtBuscarKeyReleased(java.awt.event.KeyEvent evt) {//GEN-FIRST:event_txtBuscarKeyReleased
        ...
        op.listarAutor(txtBuscar.getText());
    ...
    public void actualizar(){
        if (tablaAutores.getRowCount() > 0) {
            if (tablaAutores.getSelectedRowCount() > 0) {
                int fila = tablaAutores.getSelectedRow();
                s.setIdAutor(tablaAutores.getValueAt(fila, 0).toString());
                s.setNombreAutor(tablaAutores.getValueAt(fila, 1).toString());
    ...
    protected static javax.swing.JTable tablaAutores;
