...
public class Eliminar extends javax.swing.JFrame {
    ...
    public Eliminar() {
        ...
        lblTitulo.setText(s.getNombreAutor());
    }
    ...
    private void initComponents() {
        ...
        jLabel1.setText("Estas a punto de eliminar el siguinete autor:");
        ...
        jPanel1.add(lblTitulo, new org.netbeans.lib.awtextra.AbsoluteConstraints(200, 110, 120, 20));
    ...
    private void btnEliminarActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btnEliminarActionPerformed
        int rsu = op.eliminarAutor();
        if (rsu != 0) {
            op.listarAutor("");
            EliminarRegistro eli = new EliminarRegistro();
            eli.lblNombre.setText("autor");
            eli.setVisible(true);
            this.dispose();
        } else {
            this.dispose();
