...
public class Lista extends javax.swing.JPanel {
    ...
    void limpiaCampos() {
        if (tablaEstudiantes.getSelectedRow() > -1) {
            tablaEstudiantes.removeRowSelectionInterval(tablaEstudiantes.getSelectedRow(), tablaEstudiantes.getSelectedRow());
        }
    ...
    private void initComponents() {
        ...
        tablaEstudiantes.setModel(new javax.swing.table.DefaultTableModel(
            ...
            new String [] {
                "IdEstudiante", "Nombres", "Apellidos", "Identificación", "Dirección", "Telefono", "Sección"
            }
        ) {
    ...
    private void txtBuscarKeyReleased(java.awt.event.KeyEvent evt) {//GEN-FIRST:event_txtBuscarKeyReleased
        ...
        Opciones.listarEstudiante(txtBuscar.getText());
    ...
    public void actualizar(){
        if (tablaEstudiantes.getRowCount() > 0) {
            if (tablaEstudiantes.getSelectedRowCount() > 0) {
                ...
                s.setIdEstudiante(tablaEstudiantes.getValueAt(fila, 0).toString());
                s.setNombres(tablaEstudiantes.getValueAt(fila, 1).toString());
                s.setApellidos(tablaEstudiantes.getValueAt(fila, 2).toString());
                s.setDocumento(tablaEstudiantes.getValueAt(fila, 3).toString());
                s.setDireccion(tablaEstudiantes.getValueAt(fila, 4).toString());
                s.setTelefono(tablaEstudiantes.getValueAt(fila, 5).toString());
                s.setSeccion(tablaEstudiantes.getValueAt(fila, 6).toString());
                ActualizarRegistro act = new ActualizarRegistro();
                act.setVisible(true);
            } else {
    ...
    protected static javax.swing.JTable tablaEstudiantes;
