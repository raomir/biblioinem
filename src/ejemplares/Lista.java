...
public class Lista extends javax.swing.JPanel {
    ...
    void limpiaCampos() {
        if (tablaEjemplares.getSelectedRow() > -1) {
            tablaEjemplares.removeRowSelectionInterval(tablaEjemplares.getSelectedRow(), tablaEjemplares.getSelectedRow());
        }
        op.listarEjemplar("");
    }
    /**
    ...
    private void initComponents() {
        ...
        tablaEjemplares.setModel(new javax.swing.table.DefaultTableModel(
            ...
            new String [] {
                "IdEjemplar", "Nombre edición", "Nombre pasillo"
            }
        ) {
        ...
        tablaEjemplares.setCursor(new java.awt.Cursor(java.awt.Cursor.HAND_CURSOR));
        ...
        txtBuscar.setPlaceholder("Buscar ejemplar...");
    ...
    private void txtBuscarKeyReleased(java.awt.event.KeyEvent evt) {//GEN-FIRST:event_txtBuscarKeyReleased
        ...
        op.listarEjemplar(txtBuscar.getText());
    ...
    public void actualizar(){
        if (tablaEjemplares.getRowCount() > 0) {
            if (tablaEjemplares.getSelectedRowCount() > 0) {
                int fila = tablaEjemplares.getSelectedRow();
                s.setIdEjemplar(tablaEjemplares.getValueAt(fila, 0).toString());
                s.setNombreEdicion(tablaEjemplares.getValueAt(fila, 1).toString());
                s.setNombrePasillo(tablaEjemplares.getValueAt(fila, 2).toString());
    ...
    protected static javax.swing.JTable tablaEjemplares;
