...
public class Eliminar extends javax.swing.JFrame {
    ...
    public Eliminar() {
        ...
        lblPasillo.setText(s.getNombrePasillo());
        lblEdicion.setText(s.getNombreEdicion());
    }
    ...
    private void initComponents() {
        ...
        jPanel1.add(btnCancelar, new org.netbeans.lib.awtextra.AbsoluteConstraints(80, 210, 127, -1));
        ...
        jPanel1.add(btnEliminar, new org.netbeans.lib.awtextra.AbsoluteConstraints(220, 210, 127, -1));
        ...
        jLabel1.setText("Estas a punto de eliminar el siguinete ejemplar:");
        ...
        jPanel1.add(lblPasillo, new org.netbeans.lib.awtextra.AbsoluteConstraints(200, 150, 120, 20));

        jLabel4.setFont(new java.awt.Font("Tahoma", 0, 12)); // NOI18N
        jLabel4.setForeground(new java.awt.Color(0, 112, 192));
        jLabel4.setHorizontalAlignment(javax.swing.SwingConstants.LEFT);
        jLabel4.setText("Pasillo:");
        jPanel1.add(jLabel4, new org.netbeans.lib.awtextra.AbsoluteConstraints(140, 150, 50, 20));

        jLabel5.setFont(new java.awt.Font("Tahoma", 0, 12)); // NOI18N
        jLabel5.setForeground(new java.awt.Color(0, 112, 192));
        jLabel5.setHorizontalAlignment(javax.swing.SwingConstants.LEFT);
        jLabel5.setText("Edición:");
        jPanel1.add(jLabel5, new org.netbeans.lib.awtextra.AbsoluteConstraints(140, 110, 50, 20));
        ...
        jPanel1.add(lblEdicion, new org.netbeans.lib.awtextra.AbsoluteConstraints(200, 110, 120, 20));
    ...
    private void btnEliminarActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btnEliminarActionPerformed
        int rsu = op.eliminarEjemplar();
        if (rsu != 0) {
            op.listarEjemplar("");
            EliminarRegistro eli = new EliminarRegistro();
            eli.lblNombre.setText("ejemplar");
            eli.setVisible(true);
            this.dispose();
        } else {
            this.dispose();
