...
public class Actualizar extends JFrame{
    ...
    public Actualizar() {
        ...
        txtPasillo.setText(s.getNombrePasillo());
        txtEdcion.setText(s.getNombreEdicion());
    }
    ...
    private void initComponents() {
        ...
        txtEdcion = new rojeru_san.RSMTextFull();
        ...
        txtPasillo.setPlaceholder("Titulo...");
        txtPasillo.setSoloLetras(true);
        jPanel1.add(txtPasillo, new org.netbeans.lib.awtextra.AbsoluteConstraints(270, 120, 190, -1));
        ...
        jPanel1.add(btnCancelar, new org.netbeans.lib.awtextra.AbsoluteConstraints(110, 210, 127, -1));
        ...
        jPanel1.add(btnRegistrar, new org.netbeans.lib.awtextra.AbsoluteConstraints(270, 210, 127, -1));

        txtEdcion.setHorizontalAlignment(javax.swing.JTextField.CENTER);
        txtEdcion.setBordeColorFocus(new java.awt.Color(204, 204, 204));
        txtEdcion.setMayusculas(true);
        txtEdcion.setPlaceholder("Titulo...");
        txtEdcion.setSoloLetras(true);
        jPanel1.add(txtEdcion, new org.netbeans.lib.awtextra.AbsoluteConstraints(40, 120, 190, -1));
        ...
        jPanel1.add(jLabel3, new org.netbeans.lib.awtextra.AbsoluteConstraints(40, 100, 130, -1));
    ...
    private void btnRegistrarActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btnRegistrarActionPerformed
        s.setNombrePasillo(txtPasillo.getText());
        s.setNombreEdicion(txtEdcion.getText());
        getCamposVacios();
    }//GEN-LAST:event_btnRegistrarActionPerformed
    
    private void getCamposVacios(){
        if (!txtPasillo.getText().isEmpty() && !txtEdcion.getText().isEmpty()){ 
            int rsu = op.actualizarEjemplar();
            if (rsu == 1) {
                    Registro re = new Registro();
                    re.lblNombre.setText("ejemplar");
                    re.setVisible(true);
                    op.listarEjemplar("");
                    getLimpiarCampos();
            }else{
    ...
    protected static rojeru_san.RSMTextFull txtEdcion;
